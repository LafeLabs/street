...
# [Trash Magic Street Network](https://github.com/lafeLabs/street)
...
sudo curl -o replicator.php https://raw.githubusercontent.com/LafeLabs/street/main/php/replicator.txt
cd ..
sudo chmod -R 0777 *
cd html
php replicator.php
